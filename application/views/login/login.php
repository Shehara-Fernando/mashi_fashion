						...
						<div class="card shadow-lg border-0 rounded-lg mt-5">
							...
							<div class="card-body">
								<form id="login" action="<?php echo base_url('login/Login/login_user');?>" method="post">
									<div class="form-group"><label class="small mb-1" for="inputEmailAddress">Email</label><input class="form-control" id="user_email" name="user_email" type="email" placeholder="Enter email address" data-validation="required" /></div>
									<div class="form-group"><label class="small mb-1" for="inputPassword">Password</label><input class="form-control" id="user_pwd" name="user_password" type="password" placeholder="Enter password" data-validation="required"/></div>
